  ...
  */
  ...
  for(b=0;b<50;b++) {
    for(a=0;a<80;a++) {
      ...
      i++;
      if (i==(0x60000/0x40)) i=0x30000/0x40;
      if (i==(0x40000/0x40)) i=0x12000/0x40;
      if (i==(0x1F800/0x40)) i=0x0A000/0x40;
    }
  }
...
void load_bmpfile(void)
{
  ...
  if (read512(buffer)!=512) return;

  // Get image dimensions
  width=buffer[0x13]; width=width<<8; width+=buffer[0x12];
