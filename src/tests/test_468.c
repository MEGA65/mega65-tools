...
opcode_suite test_ldq = { "ldq", 27, 51, 0x64,
  { { 0, 0xa5, 0x01, "ldq $nn", 0 }, { 0, 0xad, 0x02, "ldq $nnnn", 0 }, { 0, 0xb2, 0x04, "ldq ($nn),z", 0 },
      { 0, 0xb2, 0x08, "ldq [$nn],z", 0 }, { 0, 0xb2, 0x08, "ldq f[$nn],z", 4 }, { 0, 0 } },
  { // LDQ - check if right value is loaded, and is Q ops are working
    // base page adressing, val1 needs to set z=0 for bp indirect z indexed!
      ...
      { 0xc, "=2 +n-z", 0x02345678, 0xfedcba98, 0xfedcba98, 0xba98fedc, 0x82, 0x80, 0 }, { 0 } } };
...
opcode_suite test_stq = { "stq", 27, 51, 0x64,
  { { 2, 0x85, 0x01, "stq $nn", 0 }, { 1, 0x8d, 0x02, "stq $nnnn", 0 }, { 1, 0x92, 0x04, "stq ($nn)", 0 },
      { 1, 0x92, 0x08, "stq [$nn]", 0 }, { 1, 0x92, 0x08, "stq f[$nn]", 4 }, { 0, 0 } },
  {
...
opcode_suite test_adcq = { "adcq", 27, 51, 0x64,
  {
  ...
  { // base page adressing
    // 12345678 + 10fedcba = 22345678 -- NVZC all unset
      ...
      { 0xf, " +n-vzc", 0x81234567, 0x81234567, 0x12345678, 0x02468ace, 0xc3, 0x41, 0 }, { 0 } } };
...
opcode_suite test_sbcq = { "sbcq", 27, 51, 0x64,
  {
  ...
  { // 12345678 - 10fedcba = 22345678 -- C set, NVZ unset
      ...
      { 0xf, " +nv-zc", 0x7fedcba9, 0xfedcba98, 0xaaddeeff, 0x81111111, 0xc3, 0xc0, 0 }, { 0 } } };
...
opcode_suite test_cmpq = { "cmpq", 27, 51, 0x64,
  {
  ...
  { // 12345678 cmp 12345678 (equal)
      ...
      { 0xf, " -+ a>m", 0xedcba987, 0x12345678, 0xaaddeeff, 0xedcba987, 0xc3, 0x81, 0 }, { 0 } } };
...
opcode_suite test_bitq = { "bitq", 27, 51, 0x64,
  {
  ...
  { { 0xf, " -nvz", 0x12345678, 0x02345678, 0xaaddeeff, 0x12345678, 0xc2, 0x00, 0 },
      ...
      { 0xf, " +znv", 0x02345678, 0xc0000000, 0xaaddeeff, 0x02345678, 0xc2, 0xc2, 0 }, { 0 } } };
...
opcode_suite test_deq = { "deq", 27, 51, 0x64,
  {
      { 0, 0x3a, 0x40, "deq q", 0 },
  ...
  { // only for implied Q-accumulator
      ...
      { 0x40, " +z-n", 0x00000001, 0x12345678, 0xaaddeeff, 0x00000000, 0x82, 0x02,
          0 }, // will succeed, because dec a will satisfy
      ...
      { 0x30, " +n-z", 0x12340278, 0x0000aadd, 0xeeff0000, 0xffffffff, 0x82, 0x80, 2 }, { 0 } } };
...
opcode_suite test_inq = { "inq", 27, 51, 0x64,
  {
      { 0, 0x1a, 0x40, "inq q", 0 },
  ...
  { // only for implied Q-accumulator
      ...
      { 0x30, " +n-z", 0x12340278, 0xffffaadd, 0xeeff7fff, 0x80000000, 0x82, 0x80, 2 }, { 0 } } };
...
opcode_suite test_andq = { "andq", 27, 51, 0x64,
  {
  ...
  { { 0xf, " -nz", 0x02345678, 0x12345678, 0x00000000, 0x02345678, 0x82, 0x00, 0 },
      ...
      { 0xf, " +n-z", 0xfe4d52e6, 0xcb38b4d9, 0x00000000, 0xca0810c0, 0x82, 0x80, 0 }, { 0 } } };
...
opcode_suite test_orq = { "orq", 27, 51, 0x64,
  {
  ...
  { { 0xf, " -nz", 0x02345678, 0x514b17cd, 0x00000000, 0x537f57fd, 0x82, 0x00, 0 },
      ...
      { 0xf, " +n-z", 0x02345678, 0xabcdef12, 0xffff0000, 0xabfdff7a, 0x82, 0x80, 0 }, { 0 } } };
...
opcode_suite test_eorq = { "eorq", 27, 51, 0x64,
  {
  ...
  { { 0xf, " -nz", 0x02345678, 0x524b17cd, 0x00000000, 0x507f41b5, 0x82, 0x00, 0 },
      ...
      { 0xf, " +n-z", 0x02345678, 0xfda577c9, 0x00000000, 0xff9121b1, 0x82, 0x80, 0 }, { 0 } } };
...
opcode_suite test_lsrq = { "lsrq", 27, 51, 0x64,
  {
  ...
  { // implied Q
      ...
      { 0x30, " +c-nz", 0x02340278, 0x5679ffff, 0xffff0234, 0x011a2b3c, 0x83, 0x01, 2 }, { 0 } } };
...
opcode_suite test_asrq = { "asrq", 27, 51, 0x64,
  {
  ...
  { // implied Q
      ...
      { 0x10, " +nc-z", 0x02340278, 0x4567eeee, 0xddddf023, 0xf811a2b3, 0x83, 0x81, 2 }, { 0 } } };
...
opcode_suite test_aslq = { "aslq", 27, 51, 0x64,
  {
  ...
  { // implied Q
      ...
      { 0x30, " +nc-z", 0x02340278, 0xba984567, 0xabcdfedc, 0xfdb97530, 0x83, 0x81, 2 }, { 0 } } };
...
opcode_suite test_rorq0 = { "rorq c=0", 27, 51, 0x64,
  {
  ...
  { // implied Q
      ...
      { 0x10, " -nzc", 0x02340278, 0x5678ffff, 0xffff0234, 0x011a2b3c, 0x83, 0x00, 2 },
      { 0x10, " +zc-n", 0x02340278, 0x0001ffff, 0xffff0000, 0x00000000, 0x83, 0x03, 2 },
      { 0x10, " +c-nz", 0x02340278, 0x5679ffff, 0xffff0234, 0x011a2b3c, 0x83, 0x01, 2 }, { 0 } } };

opcode_suite test_rorq1 = { "rorq c=1", 27, 51, 0x64,
  {
  ...
  { // implied Q
      ...
      { 0x10, " +nc-z", 0x02340278, 0x6789ffff, 0xffff2345, 0x91a2b3c4, 0x83, 0x81, 2 }, { 0 } } };
...
opcode_suite test_rolq0 = { "rolq c=0", 27, 51, 0x64,
  {
...
opcode_suite test_rolq1 = { "rolq c=1", 27, 51, 0x64,
  {
      // test with carry set
  ...
  { // implied Q
      ...
      { 0x30, " +nc-z", 0x02340278, 0xba984567, 0xabcdfedc, 0xfdb97531, 0x83, 0x81, 2 }, { 0 } } };

// defintion of all the test suites to run
opcode_suite *suites[] = { &test_ldq, &test_stq, &test_adcq, &test_sbcq, &test_cmpq, &test_bitq, &test_deq, &test_inq,
  &test_andq, &test_orq, &test_eorq, &test_lsrq, &test_asrq, &test_aslq, &test_rorq0, &test_rorq1, &test_rolq0, &test_rolq1,
  0x0 };
...
loop:
   ...
   LDY #$af
   LDZ #$f5
   ; Load test value1 to Q, LDQ $0380
   NEG
   NEG
   LDA $0380
...
unsigned char code_snippet[66] = {
  // far ptr copy loop
  0xa3, 0x0b, 0xa2, 0x0b, 0xbd, 0x80, 0x03, 0xea, 0x92, 0x60, 0x3b, 0xca, 0x10, 0xf6,
  // real start +13
  ...
  0x08, 0x8d, 0x8c, 0x03, 0x8e, 0x8d, 0x03, 0x8c, 0x8e, 0x03, 0x9c, 0x8f, 0x03, 0x68, 0x8d, 0x90, 0x03,
  // copy far ptr back
  0xa3, 0x0b, 0xa2, 0x0b, 0xea, 0xb2, 0x60, 0x9d, 0x80, 0x03, 0x3b, 0xca, 0x10, 0xf6,
  // rts
  0x60
};
...
void run_suite(unsigned char issue_num, opcode_suite *suite)
{
      ...
      if ((suite->modes[m].mode & suite->tests[t].apply_mode)) {
        ...
        *(unsigned long *)0x38c = 0xb1eb1bbe;
        ...
        if (suite->modes[m].rmw == 1)
          result_q = *(unsigned long *)(0x384 + suite->tests[t].read_offset);
        else if (suite->modes[m].rmw == 2)
          result_q = *(unsigned long *)(suite->basepage + suite->tests[t].read_offset);
        else
        ...
        if (status == TEST_FAIL) {
          snprintf(msg, 80, "#%02d*%02d - fail(%-2s) - %-20.20s q=$%04x%04x %s", issue_num, sub, failstr, testname, reshi,
              reslo, flagstr);
  ...
  if (failed > 0)
    snprintf(msg, 80, "#%02d - %-4s - %d/%d tests failed", issue_num, suite->name, failed, count);
  else
    snprintf(msg, 80, "#%02d - %-4s - %d tests passed", issue_num, suite->name, count);
