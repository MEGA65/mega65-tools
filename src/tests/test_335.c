...
void main(void)
{
  ...
  while(1) {
    ...
    switch(c) {
    case 0x4d: case 0x6d: // M - Drive motor LED on
      POKE(0xD61D,0x7f);
      POKE(0xD080,0x20); break;      
    case 0x42: case 0x62: // B - Drive LED blink
      POKE(0xD61D,0x7f);
      POKE(0xD080,0x40); break;
    case 0x4f: case 0x6f: // O - Drive LED off
      POKE(0xD61D,0x7f);
