...
void main(void)
{
  ...
  print_text(0, 0, 1, "Issue #335 - Drive error LED should be");
  print_text(0, 1, 1, "red when blinking, but still green for  ");
  print_text(0, 2, 1, "drive access. LEDs should also be user  ");
  print_text(0, 3, 1, "controllable.");
  ...
  while (1) {
    ...
    switch (c) {
    case 0x4d:
    case 0x6d: // M - Drive motor LED on
      POKE(0xD61D, 0x7f);
      POKE(0xD080, 0x20);
      break;
    case 0x42:
    case 0x62: // B - Drive LED blink
      POKE(0xD61D, 0x7f);
      POKE(0xD080, 0x40);
      break;
    case 0x4f:
    case 0x6f: // O - Drive LED off
      POKE(0xD61D, 0x7f);
      POKE(0xD080, 0x00);
      break;
