...
opcode_suite test_dew =
  {
    ...
    },
    {
      ...
      {0x01, " +n-z", 0x1234, 0x0000, 0xaadd, 0xffff, 0xc3, 0x80, 0},
      {0}
    }
  };
...
opcode_suite test_inw =
  {
    ...
    },
    {
      ...
      {0x01, " +n-z", 0x1234, 0x7fff, 0xaadd, 0x8000, 0xc3, 0x80, 0},
      {0}
    }
  };
...
opcode_suite test_asw =
  {
    ...
    },
    {
      ...
      {0x02, " +nc-z", 0x0234, 0xfedc, 0x1234, 0xfdb8, 0x83, 0x81, 0},
      {0}
    }
  };
...
opcode_suite test_row0 =
  {
    ...
    },
    {
      ...
      {0x02, " +nc-z", 0x0234, 0xfedc, 0x1234, 0xfdb8, 0xc3, 0x81, 0},
      {0}
    }
  };

opcode_suite test_row1 =
  {
    "row c=1", 63, 12, 0x64,
    {
    ...
    },
    {
      ...
      {0x02, " +nc-z", 0x0234, 0xfedc, 0x0000, 0xfdb9, 0xc3, 0x81, 0},
      {0}
    }
  };
...
opcode_suite test_phw =
  {
    ...
    },
    {
      ...
      {0x42, " !+n-z", 0x1234, 0x8fed, 0xaadd, 0x8fed, 0xc3, 0x00, 0},
      {0}
    }
  };
    ...
    for (t=0; suite->tests[t].apply_mode; t++) {
      ...
      //    !(suite->modes[m].mode & 0x40)) { // skip Q implied for now
        ...
        *(unsigned long*)0x38c = 0xb1eb1bbe;
        ...
        if (status == TEST_FAIL) {
          snprintf(msg, 80, "#%02d*%02d - fail(%-2s) - %-20.20s w=$%04x %s", issue_num, sub, failstr, testname, result_w, flagstr);
