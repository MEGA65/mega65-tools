...
/* code snippet LDA/STA
    ...
    RTS
 */
unsigned char code_ldasta[64] = { 0x78, 0xa9, 0x30, 0x5b, 0xa3, 0x02, 0xea, 0xb2, 0x00, 0x92, 0x04, 0xa9, 0x00, 0x5b, 0x58,
  0x60 };
...
/* code snippet STA/LDA
    ...
    RTS
 */
unsigned char code_stalda[64] = { 0x78, 0xa9, 0x30, 0x5b, 0xa3, 0x02, 0xea, 0x92, 0x00, 0xb2, 0x04, 0x8d, 0x0f, 0x2f, 0xa9,
  0x00, 0x5b, 0x58, 0x60 };
...
/* code snippet LDQ/STQ
    ...
    RTS
 */
unsigned char code_ldqstq[64] = { 0x78, 0xa9, 0x30, 0x5b, 0xa3, 0x02, 0x42, 0x42, 0xea, 0xb2, 0x00, 0x42, 0x42, 0x92, 0x04,
...
/* code snippet STQ/LDQ
    ...
    RTS
 */
unsigned char code_stqldq[64] = { 0x78, 0xa9, 0x30, 0x5b, 0xa3, 0x02, 0x42, 0x42, 0xea, 0x92, 0x00, 0x42, 0x42, 0xb2, 0x04,
  0x8d, 0x10, 0x2f, 0x8e, 0x11, 0x2f, 0x8c, 0x12, 0x2f, 0x9c, 0x13, 0x2f, 0xa9, 0x00, 0x5b, 0x58, 0x60 };

unsigned char test_data_near[16] = { 0xaa, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d,
  0x0e, 0x0f };

unsigned char test_data_far[16] = { 0x55, 0x10, 0x20, 0x30, 0x40, 0x50, 0x60, 0x70, 0x80, 0x90, 0xa0, 0xb0, 0xc0, 0xd0, 0xe0,
  0xf0 };
...
void main(void)
{
  ...
  if ((PEEK(0x2f05U) != 0x50) || (PEEK(0x2f06U) != 0x60) || (PEEK(0x2f07U) != 0x70) || (PEEK(0x2f08U) != 0x80)) {
    failed++;
  ...
  if ((PEEK(0x2f10U) != 0x07) || (PEEK(0x2f11U) != 0x08) || (PEEK(0x2f12U) != 0x09) || (PEEK(0x2f13U) != 0x0A)) {
    failed++;
